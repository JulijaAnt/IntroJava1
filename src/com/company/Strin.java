...
public class Strin {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < regularString1.length(); i++) {
            ...
            if ('A' == regularString1.charAt(i) || 'E' == regularString1.charAt(i) ||
                    'I' == regularString1.charAt(i) || 'O' == regularString1.charAt(i) ||
                    'U' == regularString1.charAt(i) || 'a' == regularString1.charAt(i) ||
                    'e' == regularString1.charAt(i) || 'i' == regularString1.charAt(i) ||
                    'o' == regularString1.charAt(i) || 'u' == regularString1.charAt(i)){
                counter1++;
            }
        ...
        //Task 1.Write a program to compare two strings by their length and return output that tells the
            ...
            //Task 2. Write a programm to remove the first an the last letters of a string,
            // e.g. hello becomse ell

            int length3 = (regularString3.length() - 1);
            String newText = regularString3.substring(1, regularString3.length() - 1);
            System.out.println(newText);

            //Task 3.Write a programm to reverse a string and capitalize all the letters, e.g. hello becomes OLLEH
...
// Task 4. Write a program that ads as many ' r' to ' burp' by using a variable to regulate.e.g.
// if the variable is 4, than it will return
